...
export function Topbar() {
  ...
  return (
    <header className="flex items-center justify-between border-b border-black/5 dark:border-white/10 bg-white/70 dark:bg-graphite-900/70 backdrop-blur-xl px-6 py-4">
      <div />
      <div className="flex items-center gap-4">
        ...
        {user && (
          <div className="flex items-center gap-3">
            ...
            <div className="h-9 w-9 rounded-full bg-gradient-to-br from-primary-400 to-primary-700 flex items-center justify-center text-white text-sm font-semibold">
